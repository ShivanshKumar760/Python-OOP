...
ClassesA class is a blueprint for creating objects. Here's the basic syntax for defining a class in Python:
...
ChallengePlease see the starter code on the right and complete the following tasks:
